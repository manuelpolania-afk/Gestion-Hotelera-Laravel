<section>
    <header>
        <h2 class="font-display text-lg font-bold text-brand-900">
            {{ __('Información del perfil') }}
        </h2>

        <p class="mt-1 text-sm text-brand-400">
            {{ __('Actualiza el nombre y el correo de tu cuenta.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="documento" name="documento" type="text" class="mt-1 block w-full" :value="old('documento', $user->documento)" required autocomplete="off" />
