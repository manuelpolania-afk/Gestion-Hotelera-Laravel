                ...
                <form method="POST" action="{{ route('admin.zonas.update', $zona) }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="codigo_zona" name="codigo_zona" type="text"
                                      ...
                                      :value="old('codigo_zona', $zona->codigo_zona)" required autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="descripcion" name="descripcion" rows="3"
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('descripcion', $zona->descripcion) }}</textarea>
